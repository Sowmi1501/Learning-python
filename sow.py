...
sub3=int(input("enter your maths mark:"))
sub4=int(input("enter your science mark:"))
sub5=int(input("enter your social mark:"))
sub6=int(input("enter your computer mark:"))
